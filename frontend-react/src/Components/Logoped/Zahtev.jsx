    ...
    return (
        <div className="zahtev">
            ...
            <div className="zahtev_sadrzaj">
                ...
                <div className='zrod'>Roditelj: {zahtev.roditelj.ime} {zahtev.roditelj.prezime}</div>
                <div className='zpac'>Pacijent: {zahtev.pacijent.ime} {zahtev.pacijent.prezime}</div>
                <div className='zinfo'>Paket: {zahtev.info_pacijenta} </div>
            </div>
